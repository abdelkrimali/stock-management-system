...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtpass.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/if_check_1930264.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/if_Remove_27874.png"))); // NOI18N
        jButton1.setText("Annuler");
        jButton1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 204), 2));
        ...
        jLabel5.setFont(new java.awt.Font("Leelawadee UI", 3, 36)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(dbase.Go.chekuserandpass(user, pass))
        {
            this.dispose();
             Tools.openForm(new Home());
        }
        else
        {
            Tools.msgBox("Le nom d'utilisateur et Mot de Passe sont incorrect");
            txtuser.setText("");
            txtpass.setText("");
